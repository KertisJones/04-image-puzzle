...
class WinnerIsYou(pygame.sprite.Sprite):
	def __init__(self):
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load("AWinnerIsYou.jpg")
		...
		if not pygame.mixer:
			pygame.mixer.init()
		pygame.mixer.stop()
		self.sfxWin = pygame.mixer.Sound("Zelda_-_Ocarina_of_Time_-_Treasure_Chest_1.ogg")
		self.sfxWin.play()
...
class Square(pygame.sprite.Sprite):
	...
	def __init__(self, x, y, w, h):
		...
		self.dim = (w,h)
		pygame.sprite.Sprite.__init__(self)
		self.image = pygame.image.load("Harambe" + str(x) + str(y) + ".png")
		self.rect = self.image.get_rect()
...
if not pygame.mixer:
	pygame.mixer.init()
pygame.mixer.Sound("tetris-gameboy-02.ogg").play(-1)
...
winnerIsYou = WinnerIsYou()
pygame.sprite.Group(winnerIsYou).update()
pygame.sprite.Group(winnerIsYou).draw(screen)
pygame.display.flip()
